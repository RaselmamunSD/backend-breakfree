"""Django settings for Break Free backend."""
...
if DATABASE_ENGINE == "postgres":
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("POSTGRES_DB", "breakfree_db"),
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@breakfree.com")
